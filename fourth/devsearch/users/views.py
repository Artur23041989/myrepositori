...
def create_skill(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            skill.owner =profile
            skill.save()
            messages.success(request, 'Skill was added sucsessfullly!')
            return redirect('account')
...
def update_skill(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            skill.save()
            messages.success(request, 'Skill was update sucsessfullly!')
            return redirect('account')
...
def delete_skill(request, pk):
    ...
    if request.method == "POST":
        skill.delete()
        messages.success(request, 'Skill was deleted sucsessfullly!')
        return redirect('account')
